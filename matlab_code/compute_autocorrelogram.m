...
%% Preparation
% Compute or extract from spike histogram
if isempty(spikeHistParams) || isempty(spikeHistData)
    ...
    % Extract from spike histogram if provided
    stimStartMs = spikeHistParams.stimStartMs;
    binWidthMs = spikeHistParams.binWidthMs;
    minBurstLengthMs = spikeHistParams.minBurstLengthMs;
    maxFirstInterBurstIntervalMs = spikeHistParams.maxFirstInterBurstIntervalMs;
    maxInterBurstIntervalMs = spikeHistParams.maxInterBurstIntervalMs;
    minSpikeRateInBurstHz = spikeHistParams.minSpikeRateInBurstHz;
end
...
%   Note: This is the ratio between 
